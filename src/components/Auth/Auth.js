        ...
        <Paper className={classes.paper} elevation={3}>
            ...
            <form className={classes.form} onSubmit={handleSubmit}>
                <Grid container spacing={2} >
                  { isSignup && ( 
                      <> 
                            <Input name="firstName" label="First Name" handleChange={handleChange} autoComplete="off" autoFocus half />
                ...
                <GoogleLogin clientId='348697577249-ss190ria4gkcs445297agoblfdf1q0rk.apps.googleusercontent.com' render={(renderProps) => (
